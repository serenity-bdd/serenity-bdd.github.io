---
id: rest-api-testing
title: Pruebas completas de API REST
sidebar_position: 4
---
...
```groovy
dependencies {
    testImplementation "net.serenity-bdd:serenity-core:5.3.0"
    testImplementation "net.serenity-bdd:serenity-rest-assured:5.3.0"
    testImplementation "net.serenity-bdd:serenity-screenplay-rest:5.3.0"
...
- Explora [Screenplay REST](/docs/screenplay/screenplay_rest) para más patrones de Screenplay
- Aprende sobre [Reportes de Serenity](/docs/reporting/the_serenity_reports) para reportes de pruebas de API
- Consulta [Integración con Cucumber](/docs/cucumber/cucumber-junit5) para pruebas de API estilo BDD

## Recursos

- [Documentación de Rest-Assured](https://rest-assured.io/)
- [API de JSONPlaceholder](https://jsonplaceholder.typicode.com/)
- [API de ReqRes](https://reqres.in/)
- [API de Restful-Booker](https://restful-booker.herokuapp.com/apidoc/)
