...
A partir do Serenity 5.3.1, você pode definir a hierarquia de requisitos diretamente usando **anotações** nas suas classes de teste. Isso fornece uma forma simples, explícita e declarativa de organizar seus testes em uma estrutura significativa, sem precisar depender de convenções de nomenclatura de pacotes.
