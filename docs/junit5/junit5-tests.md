...
```groovy
dependencies {
    testImplementation "net.serenity-bdd:serenity-junit5:5.0.1"
    testImplementation "net.serenity-bdd:serenity-screenplay:5.0.1"
    testImplementation "net.serenity-bdd:serenity-screenplay-webdriver:5.0.1"
